...
import 'package:pocket_swap_fisi/domain/entities/transaction.dart' as _i16;
...
abstract class $AppRouter extends _i14.RootStackRouter {
  ...
  final Map<String, _i14.PageFactory> pagesMap = {
    ...
    UpdatePhoneNumber.name: (routeData) {
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i13.UpdatePhoneNumber(),
      );
    },
  };
}
...
class ChatNavigationRoute extends _i14.PageRouteInfo<void> {
  const ChatNavigationRoute({List<_i14.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i5.GiftShopScreen]
class GiftShopRoute extends _i14.PageRouteInfo<void> {
  const GiftShopRoute({List<_i14.PageRouteInfo>? children})
      : super(
          GiftShopRoute.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i8.MapSample]
class MapSample extends _i14.PageRouteInfo<void> {
  const MapSample({List<_i14.PageRouteInfo>? children})
      : super(
          MapSample.name,
          initialChildren: children,
        );
...
class NavigatorEditProfileRoute extends _i14.PageRouteInfo<void> {
  const NavigatorEditProfileRoute({List<_i14.PageRouteInfo>? children})
      : super(
...
class TransactionsList extends _i14.PageRouteInfo<TransactionsListArgs> {
  TransactionsList({
    required List<_i16.Transaction> transactions,
    List<_i14.PageRouteInfo>? children,
  }) : super(
  ...
  static const _i14.PageInfo<TransactionsListArgs> page =
      _i14.PageInfo<TransactionsListArgs>(name);
}

class TransactionsListArgs {
  const TransactionsListArgs({required this.transactions});

  final List<_i16.Transaction> transactions;
...
/// generated route for
/// [_i13.UpdatePhoneNumber]
class UpdatePhoneNumber extends _i14.PageRouteInfo<void> {
  const UpdatePhoneNumber({List<_i14.PageRouteInfo>? children})
      : super(
